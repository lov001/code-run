...
public class TreePreOrderTraversalTest {
    ...
    TreePreOrderTraversalUsingStack classObj2 = new TreePreOrderTraversalUsingStack();
    ...
    void test_preorder_expectOutput_whenGivenInput() {
        ...
        assertEquals(output, classObj2.preorder(node1));
    }

    @Test
    void test_preorder_expectOutput_whenGivenInput2() {
        Node node14 = new Node(14, Collections.emptyList());
        Node node13 = new Node(13, Collections.emptyList());
        Node node12 = new Node(12, Collections.emptyList());
        Node node11 = new Node(11, Collections.singletonList(node14));
        Node node10 = new Node(10, Collections.emptyList());
