...
public class MaxProfitOnSellingAStock2Test {
   ...
   MaxProfitOnSellingAStock2 classObj2 = new MaxProfitOnSellingAStock2();

   @Test
   void test_maxProfit_expect7_when() {
      int[] input = {7, 1, 5, 3, 6, 4};
      Assertions.assertEquals(7, classObj.maxProfit(input));
      Assertions.assertEquals(7, classObj2.maxProfit(input));
   }
   ...
   void test_maxProfit_expect4_when() {
      ...
      Assertions.assertEquals(4, classObj2.maxProfit(input));
   }
   ...
   void test_maxProfit_expect0_when() {
      ...
      Assertions.assertEquals(0, classObj2.maxProfit(input));
   }
}
