...
public class HIndexUsingBinarySearchTest {


   HIndexUsingBinarySearch classObj = new HIndexUsingBinarySearch();
   HIndexUsingCountingSort classObj2 = new HIndexUsingCountingSort();

   @Test
   void test_hIndex_expect3_whenInputSizeIs5() {
      int[] input = {3, 0, 6, 1, 5};
      Assertions.assertEquals(3, classObj.hIndex(input));
      Assertions.assertEquals(3, classObj2.hIndex(input));
   }
   ...
   void test_hIndex_expect2_whenInputSizeIs5() {
      ...
      Assertions.assertEquals(2, classObj2.hIndex(input));
   }
   ...
   void test_hIndex_expect1_whenInputSizeIs3() {
      ...
      Assertions.assertEquals(1, classObj2.hIndex(input));
   }
