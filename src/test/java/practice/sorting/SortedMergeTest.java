...
//      classObj.sortedMerge(array1, array2, 4, 0);
      classObj.sortedMergeOptimised(array1, array2, 4, 0);
      int[] output = {3, 5, 7, 8};
...
//      classObj.sortedMerge(array1, array2, 0, 4);
      classObj.sortedMergeOptimised(array1, array2, 0, 4);
      int[] output = {3, 5, 7, 8};
      Assertions.assertArrayEquals(output, array1);
   }
...
//      classObj.sortedMerge(array1, array2, 1, 1);
      classObj.sortedMergeOptimised(array1, array2, 1, 1);
      int[] output = {4, 5};
      Assertions.assertArrayEquals(output, array1);
   }
...
//      classObj.sortedMerge(array1, array2, 4, 5);
      classObj.sortedMergeOptimised(array1, array2, 4, 5);
