...
public class CandiesTest {
   ...
   void test_requiredCandies_expect10_whenNIs6() {
      ...
      Assertions.assertEquals(10, classObj.requiredCandiesOptimised(input));
//      Assertions.assertEquals(10, classObj.requiredCandiesOptimised(input));
   }
   ...
   void test_requiredCandies_expect3_whenNIs2() {
      ...
      Assertions.assertEquals(3, classObj.requiredCandiesBFOptimised(input));
      Assertions.assertEquals(3, classObj.requiredCandiesOptimised(input));
   }
   ...
   void test_requiredCandies_expect5_whenNIs5() {
      ...
      Assertions.assertEquals(5, classObj.requiredCandiesBFOptimised(input));
      Assertions.assertEquals(5, classObj.requiredCandiesOptimised(input));
   }
   ...
   void test_requiredCandies_expect9_whenNIs5() {
      ...
      Assertions.assertEquals(9, classObj.requiredCandiesBFOptimised(input));
      Assertions.assertEquals(9, classObj.requiredCandiesOptimised(input));
   }
