...
public class CostToCutChocolateTest {
   ...
   void test_cost_expect7_whenNIs4AndCIs2() {
      ...
      Assertions.assertEquals(7, classObj.costTabulation(4, 2, input));
   }
   ...
   void test_cost_expect10_whenNIs5AndCIs3() {
      ...
      Assertions.assertEquals(10, classObj.costTabulation(5, 3, input));
   }
   ...
   void test_cost_expect23_whenNIs10AndCIs4() {
      ...
      Assertions.assertEquals(23, classObj.costTabulation(10, 4, input));
   }
   ...
   void test_cost_expect13_whenNIs10AndCIs2() {
      ...
      Assertions.assertEquals(13, classObj.costTabulation(10, 2, input));
   }
}
