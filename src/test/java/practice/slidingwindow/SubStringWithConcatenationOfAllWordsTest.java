...
public class SubStringWithConcatenationOfAllWordsTest {
   ...
   @Test
   void test_findSubstringOptimal_expectOutputOfSize2_whenWordsSizeIs2AndWordSize3() {
      String inputString = "barfoothefoobarman";
      String[] words = {"foo", "bar"};
      List<Integer> expected = new ArrayList<>();
      expected.add(0);
      expected.add(9);
      List<Integer> actual = classObj.findSubstringOptimal(inputString, words);
      Assertions.assertArrayEquals(new List[]{expected}, new List[]{actual});
   }

   @Test
   void test_findSubstringOptimal_expectOutputOfSize0_whenWordsSizeIs4AndWordSize4() {
      String inputString = "wordgoodgoodgoodbestword";
      String[] words = {"word", "good", "best", "word"};
      List<Integer> expected = new ArrayList<>();
      List<Integer> actual = classObj.findSubstringOptimal(inputString, words);
   ...
   @Test
   void test_findSubstringOptimal_expectOutputOfSize3_whenWordsSizeIs3AndWordSize3() {
      String inputString = "barfoofoobarthefoobarman";
      String[] words = {"bar", "foo", "the"};
      List<Integer> expected = new ArrayList<>();
      expected.add(6);
   ...
   @Test
   void test_findSubstringOptimal_expectOutputOfSize1_whenWordsSizeIs4AndWordSize4() {
      String inputString = "wordgoodgoodgoodbestword";
      String[] words = {"word", "good", "best", "good"};
      List<Integer> expected = new ArrayList<>();
      expected.add(8);
