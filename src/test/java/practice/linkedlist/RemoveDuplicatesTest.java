...
public class RemoveDuplicatesTest {
   ...
   RemoveDuplicates classObj = new RemoveDuplicates();

   @Test
   void test_removeDuplicates_expectSameLinkedList_whenNoDuplicates() {
   ...
   @Test
   void test_removeDuplicates_expectLinkedListWithNoDuplicate_whenDuplicatesExists() {
      Node fifth = new Node(5, null);
   ...
   @Test
   void test_removeDuplicatesWithoutExtraSpace_expectLinkedListWithNoDuplicate_whenDuplicatesExists2() {
