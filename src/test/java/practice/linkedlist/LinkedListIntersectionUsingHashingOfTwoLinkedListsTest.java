...
public class LinkedListIntersectionUsingHashingOfTwoLinkedListsTest {
    ...
    @Test
    void test_intersectionWithDifferenceOfLength_expect8_whenListsIntersectAt8() {
        Node list1 = new Node(4);
        Node val1 = new Node(1);
        Node val2 = new Node(8);
        Node val3 = new Node(4);
        ...
        val21.next = val22;
        val22.next = val2;
        Assertions.assertEquals(val2, classObj.intersectionWithDifferenceOfLength(list1, list2));
    }

    @Test
    void test_intersectionWithDifferenceOfLength_expectNull_whenListsDoNotIntersect() {
        Node list1 = new Node(2);
        Node val1 = new Node(6);
        Node val2 = new Node(4);
        list1.next = val1;
        ...
        Node list2 = new Node(1);
        list2.next = new Node(5);
        Assertions.assertNull(classObj.intersectionWithDifferenceOfLength(list1, list2));
    }

    @Test
    void test_intersectionWithDifferenceOfLength_expect2_whenListsIntersectAt2() {
        Node list1 = new Node(1);
        Node val1 = new Node(9);
        Node val2 = new Node(1);
        Node val3 = new Node(2);
        ...
        Node list2 = new Node(3);
        list2.next = val3;
        Assertions.assertEquals(val3, classObj.intersectionWithDifferenceOfLength(list1, list2));
    }

    @Test
    void test_intersectionWithDifferenceOfLength_expect15_whenListsIntersectAt15() {
        Node list1 = new Node(3);
        Node val1 = new Node(6);
        Node val2 = new Node(9);
        Node val3 = new Node(15);
