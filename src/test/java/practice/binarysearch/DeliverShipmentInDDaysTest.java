...
public class DeliverShipmentInDDaysTest {
   ...
   void test_leastWeightCapacity_expect9_whenDaysIs5() {
      ...
      Assertions.assertEquals(9, classObj.leastWeightCapacityBinarySearch(input, 5));
   }
   ...
   void test_leastWeightCapacity_expect55_whenDaysIs1() {
      ...
      Assertions.assertEquals(55, classObj.leastWeightCapacityBinarySearch(input, 1));
   }
   ...
   void test_leastWeightCapacity_expect3_whenDaysIs5() {
      ...
      Assertions.assertEquals(15, classObj.leastWeightCapacityBinarySearch(input, 5));
   }
}
