...
public class AggressiveCowsTest {
   ...
   void test_aggressiveCows_expect2_whenKIs2() {
      int[] input = {1, 2, 3};
      Assertions.assertEquals(2, classObj.aggressiveCowsBruteForce(input, 2));
   ...
   void test_aggressiveCows_expect3_whenKIs4() {
      ...
      Assertions.assertEquals(3, classObj.aggressiveCowsBruteForce(input, 4));
   ...
   void test_aggressiveCows_expect5_whenKIs2() {
      int[] input = {4, 2, 1, 3, 6};
      Assertions.assertEquals(5, classObj.aggressiveCowsBruteForce(input, 2));
