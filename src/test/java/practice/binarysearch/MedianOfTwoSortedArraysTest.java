...
public class MedianOfTwoSortedArraysTest {
   ...
   void test_median_expect5_whenNIs6AndMIs4() {
      ...
      Assertions.assertEquals(5, classObj.medianUsingBinarySearch(a, b));
   }
   ...
   void test_median_expect3Point5_whenNIs3AndMIs3() {
      ...
      Assertions.assertEquals(3.5, classObj.medianUsingBinarySearch(a, b));
   }
   ...
   void test_median_expect3_whenNIs3AndMIs2() {
      ...
      Assertions.assertEquals(3, classObj.medianUsingBinarySearch(a, b));
   }
   ...
   void test_median_expect2_whenNIs3AndMIs3() {
      ...
      Assertions.assertEquals(2, classObj.medianUsingBinarySearch(a, b));
   }
}
