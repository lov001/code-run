...
public class FirstMissingPositiveNumberTest {
   ...
   void test_missingNumber_expect3_whenNIs3() {
      ...
      Assertions.assertEquals(3, classObj.firstMissingPositiveUsingHashSet(input));
      Assertions.assertEquals(3, classObj.firstMissingPositiveOptimal(input));
   }
   ...
   void test_missingNumber_expect2_whenNIs4() {
      ...
      Assertions.assertEquals(2, classObj.firstMissingPositiveUsingHashSet(input));
      Assertions.assertEquals(2, classObj.firstMissingPositiveOptimal(input));
   }
   ...
   void test_missingNumber_expect1_whenNIs5() {
      ...
      Assertions.assertEquals(1, classObj.firstMissingPositiveUsingHashSet(input));
      Assertions.assertEquals(1, classObj.firstMissingPositiveOptimal(input));
   }
