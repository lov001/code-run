...
public class MissingNumberTest {
   ...
   void test_missingNumber_expect3_whenNIs5() {
      ...
      Assertions.assertEquals(3, classObj.missingNumberWithXor(input, 5));
   }
   ...
   void test_missingNumber_expect4_whenNIs4() {
      ...
      Assertions.assertEquals(4, classObj.missingNumberWithXor(input, 4));
   }
   ...
   void test_missingNumber_expect4_whenNIs8() {
      ...
      Assertions.assertEquals(4, classObj.missingNumberWithXor(input, 8));
   }
}
